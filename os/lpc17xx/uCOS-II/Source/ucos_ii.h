...
OS_EXT  INT8U volatile    OSPrioHighRdy;            /* Priority of highest priority task               */
...
// OS_EXT  INT32U           test1;                   /* Pointer to list of free TCBs             */
OS_EXT  OS_TCB           *OSTCBHighRdy;                    /* Pointer to highest priority TCB R-to-R   */
// OS_EXT  INT32U           test2;                   /* Pointer to list of free TCBs             */
