...
#define    USART_FIFO_EN             1                                  /* 是否开启FIFO功能(触点为8)    */
#define    USART_BPS                 115200                             /* 串口通信波特率               */
// #define    USART_RECV_BUF_SIZE       10                                 /* 接收缓冲区大小(中断模式)     */

// #define    UASART_RXFIFO_LEVEL       8                                  /* 16字节硬件FIFO，触点建议为8  */
// #define    UASART_TXFIFO_LEVEL       16                                 /* 16字节硬件接收缓冲           */
